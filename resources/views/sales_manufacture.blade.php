...
<tr>
                   ...
                   <td>{{$project->contact_no }}</td>
                    <td><form method="post" action="{{ URL::to('/') }}/confirmedmanufacture" >
                                      ...
                                      <a class="btn btn-sm btn-success " name="addenquiry" href="{{ URL::to('/') }}/requirements?projectId={{ $project->id }}" style="color:white;font-weight:bold;padding: 6px;">Add Enquiry</a>
