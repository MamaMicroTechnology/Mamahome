                ...
                <table class="table table-responsive" border=1>
                    <thead>
                        <tr style="background-color:#e6e6e6">
                            ...
                            <th>AMOUNT</th>
                            <?php       
                            $cgst = ($data['supplier']->amount * 14)/100;
                            $sgst = ($data['supplier']->amount * 14)/100;
                    ...
                    @endfor
                        ...
                        <tr>
                            <td class="text-center" colspan="6">
                                Amount In Words : &nbsp;&nbsp;&nbsp; RUPPES {{ $data['supplier']->tamount_words}} ONLY
                            </td>
                        </tr>
                        <tr class="clearfix">
                            <td colspan="6">
                                ...
                                <div class="pull-left col-md-6 clearfix">
                                    ...
                                    <br>
                                    1.       PO can be cancelled before the transit from the manufacturer/Warehouse place.
                                </div>
                                <br><br>
                            </td>
                        </tr>
