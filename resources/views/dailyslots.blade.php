                    ...
                    <tbody id="mainPanel">
                        ...
                        @foreach($projects as $project)
                           ...
                           <td style="text-align:center" >
                                <a href="{{ URL::to('/')}}/viewsubward?projectid={{$project->project_id}} && subward={{ $project->subward->sub_ward_name }}" data-toggle="tooltip" data-placement="top" title="click here to view map" class="red-tooltip" target="_blank">{{ $project->sub_ward_id}}
                             </a></td>
